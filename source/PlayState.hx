...
class PlayState extends MusicBeatState
{
	...
	var cloudsShader:Clouds;
    var cloudsBG:FlxSprite;
	...
	override public function create()
	{
		...
		cloudsShader = new Clouds();
		//cloundsShader.speed.value = [0.03];
		cloudsShader.iTime.value = [0];
		...
		switch (curStage)
		{
			...
			case 'clouds':
				...
				cloudsBG = new FlxSprite(0,-100).makeGraphic(FlxG.width*2, FlxG.height*2, FlxColor.WHITE);
				cloudsBG.updateHitbox();
				cloudsBG.screenCenter(X);
				//cloudsBG.scrollFactor.set(0, 0);
				cloudsBG.shader = cloudsShader;
				//cloundsShader.iResolution.value = [cloudsBG.width, cloudsBG.height];
				add(cloudsBG);
		}
	...
	override public function update(elapsed:Float)
	{
		...
		if (curStage == 'clouds') {
			cloudsShader.iTime.value[0] += elapsed;
		}
