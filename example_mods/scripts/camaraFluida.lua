local settings = {
    ...
    shiftCameraPixels = 128,
    smoothCamera = true,
    smoothZoom = true,
    smoothIntensity = .25, -- too much smooth or below 0 = camera wont move lmao
...
function onUpdate(dt)
    ...
    local followXAdd = (bfShift.x * (mustHitSection and pix or pix2)) 
    local followYAdd = (bfShift.y * (mustHitSection and pix or pix2))
